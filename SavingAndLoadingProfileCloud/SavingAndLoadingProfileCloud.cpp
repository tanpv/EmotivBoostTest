...
BOOST_AUTO_TEST_CASE(PRO_265*GIVEN_correct_EmotivID_WHEN_access_to_Emotiv_cloud_THEN_user_fail_to_login) {
	int errorCode;
...
BOOST_AUTO_TEST_CASE(PRO_265*GIVEN_local_valid_profile_WHEN_accessed_to_Emotiv_cloud_THEN_user_able_to_upload) {
	int errorCode;
...
BOOST_AUTO_TEST_CASE(PRO_265*GIVEN_invalid_profile_WHEN_accessed_to_Emotiv_cloud_THEN_user_fail_to_download) {
...
BOOST_AUTO_TEST_CASE(PRO_265*GIVEN_valid_profile_WHEN_accessed_to_Emotiv_cloud_THEN_user_able_to_download) {
	int errorCode;
